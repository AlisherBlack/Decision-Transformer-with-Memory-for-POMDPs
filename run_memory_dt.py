...
def parse_args():
    ...
    parser.add_argument("--n_embed", type=int, default=64, help="Embedding dimension")
    parser.add_argument(
    ...
    parser.add_argument(
        "--memory_dim", type=int, default=64, help="Dimension of memory state"
    )
    parser.add_argument(
...
def main():
    ...
    print(
        f"Evaluation complete. Mean return: {mean_return:.2f}, Success rate: {success_rate:.2%}"
    )
